...
//
//    // AmazonS3 주입받기
//    S3FileService(@Value("${cloud.aws.credentials.accessKey}") String awsId,
//                  @Value("${cloud.aws.credentials.secretKey}") String awsKey,
//                  @Value("${cloud.aws.region}") String region){
//        this.amazonS3 = AmazonS3ClientBuilder.standard().withRegion(region)
//                    .withCredentials(new AWSStaticCredentialsProvider(new BasicAWSCredentials(awsId, awsKey))).build();
//    }
//
