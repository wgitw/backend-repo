...
@Setter
@Builder
public class ChattingMessageWithBookmarkGetListPaginationRespnse {
    private List<ChattingMessageWithBookmarkGetResponse> chattingMessageWithBookmarkGetResponses;
