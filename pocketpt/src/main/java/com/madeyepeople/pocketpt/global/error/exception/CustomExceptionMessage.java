...
public enum CustomExceptionMessage {
    ...
    DISCARDED_TOKEN("이미 폐기된 토큰입니다."),
    VALID_TOKEN_EMAIL_NOT_FOUND("해당 토큰의 이메일을 가진 사용자가 존재하지 않습니다."),
    ...
    PT_MATCHING_REQUEST_ALREADY_EXIST("이미 trainer와 trainee 사이 status = pending, active인 PT 매칭 요청이 존재합니다."),
    ...
    // historical data
    HISTORICAL_DATA_NOT_FOUND("해당 HistoricalData가 존재하지 않습니다."),

    // historical data file
    HISTORY_DATA_FILE_NOT_FOUND("해당 HistoricalDataFile이 존재하지 않습니다."),
    ;
